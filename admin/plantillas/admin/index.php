...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="<? echo $app->default_lan; ?>" lang="<? echo $app->default_lan; ?>">
    <head>
        ...
        <link rel="stylesheet" type="text/css" media="screen" href="<? echo $app->ruta_admin; ?>/plantillas/admin/css/estilo.css" />
        <link href="<? echo $app->ruta_include; ?>/contextmenu/css/contextmenu.css" type="text/css" rel="stylesheet" media="screen" />
        ...
        <script type="text/javasript" src="<? echo $app->ruta_include; ?>/contextmenu/js/contextmenu.js"></script>
    ...
    <body>
        ...
        <div id="jcrop-ruta"><? echo $app->ruta_admin; ?>/popup.php?seccion=jcrop&accion=form&componente=<? echo $app->seccion; ?>&ruta=</div>
    </body>
</html>