                    ...
                    <div class="ui-widget" id="login">
                        ...
                        <form id="form-login" class="ui-widget-content ui-corner-bottom" method="post" action="<? echo $app->ruta_admin; ?>/entorno.php?seccion=login&amp;accion=enviardatos">
                            <table>
                                <tr>
                                    <td width="30%"> Nick:</td>
                                    <td><input type="text" class="ui-widget-content ui-corner-all" style="padding: 4px;" name="nick" /><br/><br/></td>
                                </tr>
                                <tr>
                                    <td>Pass:</td>
                                    <td><input type="password" class="ui-widget-content ui-corner-all" style="padding: 4px;" name="pass" /></td>
                                </tr>
                            </table>
                            <br/>
