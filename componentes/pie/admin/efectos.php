$(document).ready(function(){
    ...
    $("#registro-link").click(function(){
        ...
        //$("#registropanel").adjustPanel(); //Run the adjustPanel function on #alertpanel
    });
	...
	$("#registropanel").adjustPanel(); //Run the adjustPanel function on #chatpanel
	...
	$(window).resize(function () {
		...
		$("#alertpanel").adjustPanel();
                $("#registropanel").adjustPanel();
	});

	//Click event on Chat Panel + Alert Panel
	$("#registropanel a:first, #alertpanel a:first, #userpanel a:first").click(function() { //If clicked on the first link of #chatpanel and #alertpanel...
