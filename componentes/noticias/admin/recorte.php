...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="<? echo $app->default_lan; ?>" lang="<? echo $app->default_lan; ?>">
    ...
    <body>
        ...
        <div class="ui-corner-all form_block" id="form">
            <form class="form" name="form" method="post" action="<? echo $app->ruta_admin.'/entorno.php?seccion='.$app->seccion.'&amp;accion=guardarimagen'?>" enctype="multipart/form-data" >
