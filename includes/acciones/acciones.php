...
<div id="reporte" title="Enviar Reporte de error">
    ...
    <table width="100%">
        ...
        <tr>
            ...
            <td><? echo ucfirst($usuario->nombre); ?></td>
        </tr>

    </table>
    <br/>
    Describa el error y los posibles mensajes que hayan aparecido en pantalla:
    <form method="post" action="<? echo $app->ruta_admin; ?>/entorno.php?seccion=reportes" id="reporte_form">
        ...
        <input type="hidden" name="usuario" value="<? echo $usuario->nombre; ?>" />
        <textarea id="reporte_text" class="ui-corner-all ui-state-default" name="descripcion" style="width:580px; height: 110px;"></textarea>
    </form>
</div>
