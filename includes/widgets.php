<script type="text/javascript">
    ...
    $(".desactivar_adjunto").live('click', function(){
     ...
     function abrirGaleria(galeria,nombre){        
        $("#titulo-galeria").text('Galería '+ nombre);
        $("#id_actual").text(galeria);
        $("#galerias").load("<? echo $app->ruta_admin; ?>/entorno.php?seccion=<? echo $app->seccion; ?>&accion=listado&galeria="+ galeria);
    }
