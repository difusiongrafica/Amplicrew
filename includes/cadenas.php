...
function eliminarAtributosHtml($cadena,$atributo){
    /*$patron = '/'.$atributo.'="(.*)"/';
...
function verFecha($fecha, $lan) {
    ...
    switch ($lan):
        ...
        case "it":
        case "fr":
            return strftime("%e", $MiTimesTamp) . "." . strftime("%m", $MiTimesTamp).'.'.strftime("%Y", $MiTimesTamp);
        case "en":
...
function verFecha2($fecha, $lan) {
    ...
    $l['de'][3] = 'deu_deu';
    @ereg("([0-9]{1,2})-([0-9]{1,2})-([0-9]{2,4})", $fecha, $mifecha);
    $MiTimesTamp = mktime(0, 0, 0, $mifecha[1], $mifecha[2], $mifecha[3]);
    ...
    switch ($lan):
        ...
        case "it":
        case "fr":
            return strftime("%e ", $MiTimesTamp) . " de " . ucfirst(strftime("%B ", $MiTimesTamp)) . " del " . strftime("%Y", $MiTimesTamp);
        case "en":
            $cola = date('S', $MiTimesTamp);
            return strftime("%e" . $cola . " %B %Y", $MiTimesTamp);
        case "de":
